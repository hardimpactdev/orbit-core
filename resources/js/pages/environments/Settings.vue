...
// Tab navigation
type TabId = "environment" | "configuration" | "dns" | "access" | "templates" | "ssh-keys" | "desktop" | "health" | "danger";

const tabs = computed(() => {
    const allTabs = [
        { id: "environment" as TabId, label: "Environment", icon: Server },
        { id: "configuration" as TabId, label: "Configuration", icon: FolderOpen },
        { id: "dns" as TabId, label: "DNS Mappings", icon: Globe },
        { id: "access" as TabId, label: "External Access", icon: ExternalLink },
        { id: "templates" as TabId, label: "Templates", icon: FileCode2 },
        { id: "ssh-keys" as TabId, label: "SSH Keys", icon: Key },
        { id: "desktop" as TabId, label: "Desktop", icon: Monitor },
        { id: "health" as TabId, label: "Health Check", icon: Stethoscope },
        { id: "danger" as TabId, label: "Danger Zone", icon: AlertTriangle },
    ];

    // In web mode (non-multi-environment), hide SSH Keys, Desktop, and Danger Zone
    if (!multiEnvironment.value) {
        return allTabs.filter(tab => !["ssh-keys", "desktop", "danger"].includes(tab.id));
    }

    return allTabs;
});

const activeTab = ref<TabId>("environment");
...
watch(
    () => externalAccessForm.external_access,
    (newValue, oldValue) => {
...
<template>
    ...
    <div class="flex h-full">
        ...
        <aside class="sticky top-0 h-screen w-52 shrink-0 border-r border-zinc-800 bg-zinc-950">
            <div class="flex h-full flex-col">
                <!-- Header -->
                <div class="p-6">
                    <h1 class="text-lg font-semibold text-white">Settings</h1>
                    <p class="text-sm text-zinc-400">Configure {{ environment.name }}</p>
                </div>
                ...
                <nav class="flex-1 space-y-1 px-3">
                    <button
                        ...
                        :class="[
                            ...
                            tab.id === 'danger' && 'text-red-400 hover:text-red-400',
                        ]"
                    >
        ...
        <main class="flex-1 p-6 lg:p-8 overflow-auto">
            <div class="max-w-2xl mx-auto">
                ...
                <div v-if="activeTab === 'environment'">
                    <header class="mb-8">
                        <h2 class="text-2xl font-semibold tracking-tight text-white">Environment</h2>
                        <p class="text-sm text-zinc-400 mt-1">Configure your development environment settings</p>
                    </header>
                ...
                <div v-if="activeTab === 'configuration'">
                    <header class="mb-8">
                        <h2 class="text-2xl font-semibold tracking-tight text-white">Configuration</h2>
                        <p class="text-sm text-zinc-400 mt-1">Configure site paths, TLD, and PHP settings</p>
                    </header>
                ...
                <div v-if="activeTab === 'dns'">
                    <header class="mb-8">
                        <h2 class="text-2xl font-semibold tracking-tight text-white">DNS Mappings</h2>
                        <p class="text-sm text-zinc-400 mt-1">Configure DNS resolution for development domains</p>
                    </header>
                ...
                <div v-if="activeTab === 'access'">
                    <header class="mb-8">
                        <h2 class="text-2xl font-semibold tracking-tight text-white">External Access</h2>
                        <p class="text-sm text-zinc-400 mt-1">Configure external access settings for this environment</p>
                    </header>

                    <div class="flex flex-col sm:flex-row sm:items-center gap-4 py-6">
                        <div class="sm:w-1/2 space-y-1">
                            <Label class="text-sm font-medium text-white">Enable External Access</Label>
                    ...
                    <div v-if="externalAccessForm.external_access" class="space-y-4 py-4">
                        <Separator class="bg-zinc-800" />
                        <div class="flex flex-col sm:flex-row sm:items-start gap-4 py-6">
                            <div class="sm:w-1/2 space-y-1">
                ...
                <div v-if="activeTab === 'templates'">
                    <header class="mb-8">
                        <h2 class="text-2xl font-semibold tracking-tight text-white">Templates</h2>
                        <p class="text-sm text-zinc-400 mt-1">Manage your favorite site templates for quick project creation</p>
                    </header>
                ...
                <!-- SSH Keys Tab -->
                <div v-if="activeTab === 'ssh-keys'">
                    <header class="mb-8">
                        <h2 class="text-2xl font-semibold tracking-tight text-white">SSH Keys</h2>
                        <p class="text-sm text-zinc-400 mt-1">SSH keys for environment provisioning</p>
                    </header>
                ...
                <div v-if="activeTab === 'desktop'">
                    <header class="mb-8">
                        <h2 class="text-2xl font-semibold tracking-tight text-white">Desktop</h2>
                        <p class="text-sm text-zinc-400 mt-1">Configure desktop app behavior</p>
                    </header>
                ...
                <div v-if="activeTab === 'health'">
                    <header class="mb-8">
                        <h2 class="text-2xl font-semibold tracking-tight text-white">Health Check</h2>
                        <p class="text-sm text-zinc-400 mt-1">Monitor and diagnose environment health</p>
                    </header>
                    ...
                    <div class="flex items-center gap-4 py-6">
                        ...
                        <div class="flex-1">
                            ...
                            <p v-else class="text-sm font-medium text-white">Ready to check</p>
                    ...
                    <!-- Results -->
                    <div v-if="doctorResult" class="space-y-2 mt-6">
                        <!-- Summary -->
                ...
                <div v-if="activeTab === 'danger'">
                    <header class="mb-8">
                        <h2 class="text-2xl font-semibold tracking-tight text-red-400">Danger Zone</h2>
                        <p class="text-sm text-zinc-400 mt-1">Irreversible and destructive actions</p>
                    </header>
